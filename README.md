...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f04ed553-66b0-432c-aebe-51965ced7734
```

> `f04ed553-66b0-432c-aebe-51965ced7734` is the password of the certificate, you can change it to any password you want.
